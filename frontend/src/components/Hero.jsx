...
export default function Hero() {
  ...
  const slides = [
    ...
    {
      title: 'Expert Home Repairs and Cleaning',
  ...
  return (
    <section className="hero" style={{ 
      ...
      <div className="hero-container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 2 }}>
        ...
        <div style={{
          ...
          {popularServices.map((service, index) => (
            <button
              ...
              onMouseLeave={(e) => {
                e.target.style.transform = `translateY(${(index % 2 === 0 ? 10 : -10)}px)`;
              }}
            >
      ...
      {/* Trust Indicators - Row Layout Below */}
      <div style={{
        display: 'flex',
