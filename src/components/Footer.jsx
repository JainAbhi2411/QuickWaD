      ...
      <div style={{ padding: '60px 20px 40px 20px' }}>
        <div style={{ 
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0 }}>
              {[
                'About Us', 'How It Works', 'Careers', 'Press & Media', 
                'Partner With Us', 'Investor Relations', 'Success Stories'
              ].map((item, index) => (
                <li key={index} style={{ marginBottom: '12px' }}>
                  <a href="#" style={{
                    color: '#d1d5db',
          ...
          <div>
            ...
            <div style={{ marginBottom: '25px' }}>
              {[
                { icon: '📞', text: '1-800-SERVICEPRO', label: 'Call Us' },
                { icon: '✉️', text: 'support@servicepro.com', label: 'Email Us' },
